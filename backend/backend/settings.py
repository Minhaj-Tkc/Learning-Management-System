...
SECRET_KEY = 'django-insecure-$^zhgl)g%))@iog6xhx+msptx-ga=d@)y23vc$pcn9#5hz#*xl'
...
JAZZMIN_SETTINGS  = {
    ...
    "site_header": "EduCloud LMS",
    "site_brand": "EduCloud",
    "site_logo": "assets/educloud.png",
    "welcome_sign": "Welcome to the EduCloud LMS",
    "copyright": "EduCloud Ltd",
